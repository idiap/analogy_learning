...
for i in range(0,10):
    ...
    train_loss = losses.CosLoss(model=model, sentence_embedding_dimension=model.get_sentence_embedding_dimension(),
                                    num_labels=2)
    ...
    dev_evaluator = EmbeddingSimilarityEvaluator.from_input_examples(dev_samples, batch_size=len(dev_samples), name='sts-dev')
