...
test_dat.to_csv("test_dat_results_splits_untrained.csv")
...
test_dat_rank.to_csv("rank_results_splits_untrained.csv")
...
test_dat.to_csv("test_dat_results_semantic_split_untrained.csv")
