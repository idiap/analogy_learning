...
test_dat.to_csv("test_dat_results_splits_notrain.csv")
...
test_dat_rank.to_csv("rank_results_splits_notrain.csv")
...
test_dat.to_csv("test_dat_results_semantic_split10_notrain.csv")
